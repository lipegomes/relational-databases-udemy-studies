...
CREATE TABLE IF NOT EXISTS `universidade_u`.`projeto_funcionario` (
  ...
  `data_criacao_projeto` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `universidade_u`.`projeto_funcionario2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `universidade_u`.`projeto_funcionario2` (
  ...
  CONSTRAINT `projeto_funcionario2_ibfk_1`
    FOREIGN KEY (`fk_id_codigo`)
    REFERENCES `universidade_u`.`projeto` (`id_codigo`),
  CONSTRAINT `projeto_funcionario2_ibfk_2`
